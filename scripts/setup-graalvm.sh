...
# refresh both hashes together when that happens.
line="25i2"
...
case "$(uname -m)" in
    ...
    aarch64 | arm64)
        ...
        ;;
    *)
        echo "setup-graalvm: unsupported architecture $(uname -m)" >&2
        exit 1
        ;;
esac
